...
<footer class="bg6 p-t-45 p-b-43 p-l-45 p-r-45">
    ...
    <div class="t-center p-l-15 p-r-15">
        <a href="#">
            <img class="h-size2" src="<?= base_url('assets/template/') ?>images/icons/paypal.png" alt="IMG-PAYPAL">
        </a>

        <a href="#">
            <img class="h-size2" src="<?= base_url('assets/template/') ?>images/icons/visa.png" alt="IMG-VISA">
        </a>

        <a href="#">
            <img class="h-size2" src="<?= base_url('assets/template/') ?>images/icons/mastercard.png" alt="IMG-MASTERCARD">
        </a>

        <a href="#">
            <img class="h-size2" src="<?= base_url('assets/template/') ?>images/icons/express.png" alt="IMG-EXPRESS">
        </a>

        <a href="#">
            <img class="h-size2" src="<?= base_url('assets/template/') ?>images/icons/discover.png" alt="IMG-DISCOVER">
        </a>
