  ...
  <div class="row text-center">
    <?php foreach ($obat as $obt) : ?>
      <div class="card ml-4 mb-3" style="width: 15rem;">
        <img src="<?= base_url('assets/img/obat/') . $obt->gambar ?>" class="card-img-top" style="height : 12rem;" alt="...">
        <div class="card-body mt-1 ">
          <h5 class="card-title mb-1"><?= $obt->namaobat ?></h5>
          <p class="card-text mb-3"> Rp. <?= number_format($obt->harga, 0, ',', '.') ?></p>
          <div class="button">
            <a href="<?= base_url('Dashboard/tambahkeranjang/') . $obt->idobat ?>" class="btn btn-sm btn-primary">Tambah Keranjang</a>
